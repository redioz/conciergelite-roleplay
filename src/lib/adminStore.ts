...
export const DEFAULT_ADMIN_SETTINGS: AdminGlobalSettings = {
  ...
  keywords: [
    'ConciergÉlite:3', 'conciergerie:3', 'Airbnb:3', 'courte durée:3',
    'longue durée:2', 'Marrakech:2', 'Guéliz:2', 'Tanger:2', 'Casablanca:2',
    'fiches de police:3', 'check-in:2', 'check-out:2',
    'taux d\'occupation:3', 'MAD:2', 'dirhams:2', 'taxe de séjour:3',
    'rendement:2', 'commission:2',
  ],
  voiceStability: 0.5,
